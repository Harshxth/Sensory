...
const INJECTED_STYLES = `
  ...
  .btn-modern-dark {
      background: linear-gradient(180deg, #225f1c 0%, #113a1e 100%);
      color: #FFFFFF;
...
export function CinematicHero({
  brandName = "Sensory",
  tagline1 = "Maps that know",
  tagline2 = "how a place feels.",
  cardHeading = "Accessibility, redefined.",
  cardDescription = (
    <>
  ...
  useEffect(() => {
    ...
    // ── Auto-scroller (only when ?auto=1 is opted in OR on /standby) ──
    // Drives `window.scrollTo` on a timer so the page scrolls itself
    // top→bottom→top→… and ScrollTrigger advances the timeline. Pauses
    // when the user touches the wheel/keyboard so it never fights them.
    const isStandby =
      typeof window !== "undefined" && window.location.pathname.startsWith("/standby");
    let raf = 0;
    let direction = 1;
    ...
    >
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a
            href="https://sensorymap.vercel.app/map"
            className="btn-modern-light flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem]"
          >
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-neutral-500 uppercase mb-[-2px]">
                Open the live map
              </div>
              <div className="text-xl font-bold leading-none tracking-tight">sensorymap.vercel.app</div>
            </div>
          </a>
          <a
            href="https://sensorymap.vercel.app/onboarding"
            className="btn-modern-dark flex items-center justify-center gap-3 px-8 py-4 rounded-[1.25rem]"
          >
            <div className="text-left">
              <div className="text-[10px] font-bold tracking-wider text-emerald-100/70 uppercase mb-[-2px]">
                Build your profile
              </div>
              <div className="text-xl font-bold leading-none tracking-tight">Begin onboarding</div>
            </div>
          </a>
        </div>
      </div>
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                >
                  ...
                  <div className="absolute inset-[7px] bg-[#0a1612] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    <div className="absolute top-[5px] left-1/2 -translate-x-1/2 w-[100px] h-[28px] bg-black rounded-full z-50 flex items-center justify-end px-3">
                      <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 shadow-[0_0_8px_rgba(34,197,94,0.8)] animate-pulse" />
                    </div>

                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-emerald-200/70 uppercase tracking-widest font-bold mb-1">USF · Tampa</span>
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Calm route</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-emerald-100 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">SR</div>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="phone-widget widget-depth rounded-2xl p-3 flex items-center">
                          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-amber-500/20 to-amber-600/5 flex items-center justify-center mr-3 border border-amber-400/20">
                            <svg className="w-4 h-4 text-amber-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Calm route picked</p>
                    <p className="text-emerald-200/60 text-[10px] lg:text-xs font-medium">Avoids 1 loud zone</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Sign read aloud</p>
                    <p className="text-amber-200/60 text-[10px] lg:text-xs font-medium">In your comfort voice</p>
                  </div>
                </div>
              </div>
            </div>
